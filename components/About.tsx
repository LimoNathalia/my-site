...
export default function About() {
  return (
    <div className="relative flex items-center justify-center z-40 py-12 md:py-20">
      <div className="bg-black mt-32 pb-20 sm:mt-56 sm:pb-24 xl:pb-0">
          ...
          >
            ...
            <defs>
              <linearGradient id="a" x1="1097.04" x2="-173.036" y1=".267" y2="307.794" gradientUnits="userSpaceOnUse">
                <stop stopColor="#000407" />
                <stop offset={1} stopColor="#edb518" />
              </linearGradient>
            </defs>
          </svg>
        </div>
          ...
          <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:py-24 xl:px-16">
            <figure className="relative isolate pt-6 sm:pt-12">
              ...
              <blockquote className="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                <p>
                  I'm a Frontend Developer from Venezuela, based in Vienna. Curious by nature and always looking to develop
                  myself further.
                  <br />
                  <br />
              ...
              <figcaption className="mt-8 text-base">
                <div className="font-semibold text-white">Nathalia Limo</div>
                <div className="mt-1 text-secondary">Frontend Developer, UX/UI Designer</div>
              </figcaption>
            </figure>
          </div>
        </div>
